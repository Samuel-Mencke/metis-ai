...
export const PROVIDERS: ProviderDefinition[] = [
  ...
  },
  {
    ...
    models: models(
      { id: "gpt-5", displayName: "GPT-5", tags: ["balanced"], contextWindow: 400_000 },
      { id: "gpt-5-mini", displayName: "GPT-5 Mini", tags: ["fast"], contextWindow: 400_000 },
      { id: "gpt-5-codex", displayName: "GPT-5 Codex", tags: ["coding", "reasoning"], contextWindow: 400_000 },
    ),
  ...
  },
  {
    ...
    models: models(
      ...
      { id: "claude-opus-4-6", displayName: "Claude Opus", tags: ["reasoning"], contextWindow: 200_000 },
  ...
  },
  {
    ...
    models: models(
      ...
      { id: "gemini-2.5-pro", displayName: "Gemini 2.5 Pro", tags: ["reasoning", "coding"], contextWindow: 1_048_576 },
    ),
  ...
  },
  {
    ...
    capabilities: chatCapabilities,
    models: models(
      { id: "grok-4", displayName: "Grok 4", tags: ["reasoning"], contextWindow: 2_000_000 },

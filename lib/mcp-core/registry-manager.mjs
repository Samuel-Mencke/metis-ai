...
import { CallToolRequestSchema, ListToolsRequestSchema } from '/home/f1shy312/ai-chat/node_modules/.pnpm/node_modules/@modelcontextprotocol/sdk/dist/esm/types.js';
...
const PUBLIC_URL = process.env.MCP_PUBLIC_URL || 'http://localhost:8799';
const TOKEN_USER = process.env.MCP_TOKEN_USER || os.userInfo().username;
const TOKEN_HOST = process.env.MCP_TOKEN_HOST || os.hostname();
const PC_USER = process.env.MCP_PC_USER || 'User';
const PC_HOST = process.env.MCP_PC_HOST || '';
const LAPTOP_USER = process.env.MCP_LAPTOP_USER || os.userInfo().username;
const LAPTOP_HOST = process.env.MCP_LAPTOP_HOST || '';
...
7. Never invent missing API keys. Store approved keys in \`${SECRETS}\`.

...
function internalLeaseHeaders() {
  return {
    "X-AI-Chat-Worker-Id": process.env.AI_CHAT_WORKER_ID || "",
    "X-AI-Chat-Lease-Token": process.env.AI_CHAT_JOB_LEASE_TOKEN || "",
  };
}
